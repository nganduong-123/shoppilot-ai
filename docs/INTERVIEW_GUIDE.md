...
> Built ShopPilot AI, a multi-tenant commerce agent using FastAPI, Groq and tool calling; implemented a revenue-prioritized omnichannel inbox, catalog-grounded recommendations, human handoff, auditable traces, and confirmation-gated order workflows, validated with automated tests and scenario-based evaluation.
